    ...
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28'>
       ...
       <div className='flex flex-col justify-center items-start gap-6'>
        ...
        <p className='text-gray-500'>Tel: (415) 555-0132 <br /> Email:jahhdhe@gmail.com</p>
        <p className='font-semibold text-xl text-gray-600'>Careers at Flamingo</p>
        <p className='text-gray-500'>Learn more about Job openings at Flamingo</p>
